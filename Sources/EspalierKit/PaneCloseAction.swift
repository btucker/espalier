...
/// What Espalier should do when libghostty's `close_surface_cb` fires for
...
/// `isSessionMissing && !espalierInitiated` — cannot distinguish an
...
/// through `killZmxSession`, so `espalierInitiated` reads as false in
